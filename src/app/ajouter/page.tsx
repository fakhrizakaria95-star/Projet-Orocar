  ...
  return (
    <main className="min-h-screen bg-[#050505] text-white font-sans flex flex-col items-center">
      ...
      <div className="w-full max-w-2xl px-6 py-12">
        <h1 className="text-4xl font-black mb-2 italic uppercase">Mettre en location</h1>
        <p className="text-zinc-400 mb-10 font-medium tracking-tight">Partagez votre véhicule et commencez à gagner.</p>

        <form className="space-y-8">
          <div className="bg-zinc-900/40 p-8 rounded-3xl border border-zinc-800 space-y-6">
            <h2 className="text-xs font-bold text-orange-500 uppercase tracking-widest">Localisation</h2>
            <div className="flex flex-col gap-2">
              <label className="text-[10px] font-bold text-zinc-500 ml-1 uppercase">Ville de stationnement</label>
              <select 
                className="bg-zinc-800 p-4 rounded-xl border border-zinc-700 focus:border-orange-500 outline-none transition font-bold text-sm text-white appearance-none cursor-pointer"
                defaultValue=""
              >
                <option value="" disabled>Où se trouve la voiture ?</option>
                {VILLES.map((ville) => (
          ...
          <div className="bg-zinc-900/40 p-8 rounded-3xl border border-zinc-800 space-y-6">
            <h2 className="text-xs font-bold text-orange-500 uppercase tracking-widest">Le Véhicule</h2>
            ...
            <input type="number" placeholder="Prix de location par jour (DH)" className="w-full bg-zinc-800 p-4 rounded-xl border border-zinc-700 focus:border-orange-500 outline-none transition font-bold text-orange-400 text-sm" />
          </div>
